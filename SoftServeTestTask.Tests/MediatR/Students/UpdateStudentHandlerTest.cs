...
namespace SoftServeTestTask.Tests.MediatR.Students
{
    ...
    {
        private readonly Mock<ILogger<UpdateStudentHandler>> _loggerMock;
        ...
        {
            _loggerMock = new Mock<ILogger<UpdateStudentHandler>>();
        ...
        {
            // Arrange
            var handler = new UpdateStudentHandler(_loggerMock.Object, _studentRepositoryMock, _courseRepositoryMock);
